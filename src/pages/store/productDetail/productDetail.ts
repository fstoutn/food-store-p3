...
const productName =
document.querySelector<HTMLHeadingElement>("#product-name");
...
const productPrice =
document.querySelector<HTMLParagraphElement>("#product-price");

const productStock =
document.querySelector<HTMLParagraphElement>("#product-stock");

const productStatus =
document.querySelector<HTMLSpanElement>("#product-status");
...
const addButton =
document.querySelector<HTMLButtonElement>("#add-to-cart");

const detailError =
document.querySelector<HTMLParagraphElement>("#detail-error");
...
const cartBadge =
document.querySelector<HTMLSpanElement>("#cart-badge");
...
activo: true,
imagenUrl:
"https://acdn-us.mitiendanube.com/stores/001/071/578/products/limonada-menta-y-jengibre-2-5bd65ef9136235048a17762796324309-640-0.webp",
categoria: {
id: 2,
nombre: "Bebidas",
...
try {
    product = await apiRequest<IProduct>(
        `/productos/${productId}`
    );
    ...
    console.warn(
        "No se pudo cargar el producto desde la API. Usando datos de prueba.",
        error
    );
